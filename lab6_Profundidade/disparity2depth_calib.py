...
print('Reading the mapping values for stereo image rectification')
...
print('Reading the stored the StereoBM parameters')
...
print(' Creating an object of StereoBM algorithm')
